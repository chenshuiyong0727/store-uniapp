  ...
  >
    <view class="content">
      ...
      <div class="flex-box">
        ...
        <view
          :style="{
            marginLeft: rightImage ? '0' : '90rpx',
            marginRight: rightImage ? '90rpx' : '0',
            zIndex: '99999',
          }"
          class="title"
          >{{ title }}</view
      ...
      >
        <view class="close" v-if="isShowCloseBtn" @click="closeHandle"
          >关闭引导</view
        >
        <view class="next" v-if="isShowNextBtn" @click="nextHandle"
          >知道了</view
        >
      </view>
    </view>
...
.tip-container {
  ...
  .content {
    ...
    @keyframes mymove5 {
      ...
      to {
        transform: translate(35rpx, 0rpx);
      }
    }
    @-webkit-keyframes mymove5 {
      ...
      to {
        transform: translate(35rpx, 0rpx);
        -webkit-transform: translate(35rpx, 0rpx);
      }
    }
    ...
    @keyframes mymove6 {
      ...
      to {
        transform: translate(0rpx, 35rpx);
      }
    }
    @-webkit-keyframes mymove6 {
      ...
      to {
        transform: translate(0rpx, 35rpx);
        -webkit-transform: translate(0rpx, 35rpx);
      }
    }
    @keyframes mymove7 {
      from {
