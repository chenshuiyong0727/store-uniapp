            ...
            <view class="btm">
              ...
              <view class="btm-right">
                ...
                <view class="button-group">
                  ...
                  <!-- <view v-else @click="showKfCode">添加健康管理师</view> -->
                  <view class="_view">
                    <view v-if="!item.payStatus || item.payStatus == 0">
                      <payment @nextHandle="nextHandle" @closePayResultHandle="closePayResultHandle" :price="item.amount" buyType="5" :goodsId="item.goodsId" :addressFlag="+item.addressFlag" btnText="训练">
    ...
    methods: {
      getGoodsList() {
        this.$request({
          ...
          if (res.status === 1000) {
            this.purchasedGoods = res.data ? res.data.filter(item => item.payStatus == '1' && item.businessType == '2210081722147310027') : []
            this.goodsList = res.data ? res.data.filter(item => item.payStatus != '1' && item.businessType == '2210081722147310027') : []
          } else {
            uni.showToast({
              title: res.msg,
              icon: 'none',
    ...
    .container {
        ...
        .purchased-list {
          ...
          .desc {
            ...
            .desc-right {
              ...
              background-size: 708rpx 260rpx;
              flex: 0 0 260rpx;
              padding: 90rpx 0 40rpx 0rpx;
              .fl-list {
                flex-direction: row;
                .fl-list-top {
                  display: flex;
      ...
      .list {
        ...
        .list-top {
          ...
          padding: 40rpx 36rpx 0rpx 36rpx;
          .img-bg {
            width: 288rpx;
            height: 288rpx;
          }
        ...
        .list-btm {
          ...
          padding: 30rpx 44rpx 50rpx 44rpx;
          .price {
            margin-bottom: 34rpx;
            &>view:nth-child(1) {
              padding-right: 18rpx;
