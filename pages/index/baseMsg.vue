  ...
  <view>
    ...
    <view class="fenlei_top_tab"  style="display: flex;">
      ...
      <view class="fenlei_top_right" @click="isShowDialog2 = true">
        <image v-if="queryParam.type || queryParam.content || ( queryParam.waitType && queryParam.waitType != '1')"  src="../../static/img/search.png"></image>
...
<!--        内容  end-->
  ...
  <view class="zuoyouduiqi" style="border-top: 1px solid #eee; padding: 10px 0 0 0">
    ...
    <view>
      <text class="dw-button-common" v-if="item.inventoryId || item.type== 3 || item.type == 12">详情</text>
